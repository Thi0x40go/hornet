...
const SQL_KEYWORDS: &[&str] = &[
    ...
    "UPDATE", "SET", "DELETE", "CREATE", "TABLE", "DROP", "ALTER", "ADD", "COLUMN", "INDEX",
    "VIEW", "SCHEMA", "DATABASE", "AS", "DISTINCT", "AND", "OR", "NOT", "IN", "BETWEEN",
    "LIKE", "IS", "NULL", "TRUE", "FALSE", "CASE", "WHEN", "THEN", "ELSE", "END", "UNION",
    "ALL", "EXISTS", "ANY", "CAST", "COALESCE", "WITH", "RECURSIVE", "PRIMARY", "KEY",
    "FOREIGN", "REFERENCES", "DEFAULT", "UNIQUE", "CHECK", "CONSTRAINT", "CASCADE",
];

const SQL_FUNCTIONS: &[&str] = &[
    "COUNT", "SUM", "AVG", "MIN", "MAX", "NOW", "DATE", "SUBSTRING", "TRIM", "UPPER",
    "LOWER", "CONCAT", "LENGTH", "ROUND", "FLOOR", "CEIL", "ABS", "COALESCE", "NULLIF",
    "JSON_EXTRACT", "ROW_NUMBER", "RANK", "DENSE_RANK",
];
